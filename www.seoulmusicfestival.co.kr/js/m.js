    ...
    s3 : {
        ...
        slide : function(){
            ...
            let pcArray = {
                ...
                dd : [`다양한 취향을 저격할<br>다채로운 장르의 메인 공연`,`K-MUSIC 및 대중문화의<br>모든 것을 경험하는 프로그램`,`메이크업·패션 트렌드 등<br>K-뷰티를 경험하는 프로그램`],
                li : [
                    ['Beautiful Stage','Soulful Stage','Powerful Stage','Wonderful Stage'],
                    ['SMUF Talk - 뮤직','SMUF 버스킹','K-Culture 체험 Zone'],
                    ['SMUF Talk - 뷰티','SMUF Beauty Zone','SMUF x 크리에이터 라이브 방송']
                ]
            }

            if(window.location.pathname == "/eng" || window.location.pathname == "/eng/"){
                pcArray = {
                    title : ['STAGE','MUSIC','BEAUTY'],
                    dd : [
                    ...
                    li : [
                        ...
                        ['SMUF Talk - Beauty','SMUF Beauty Zone','SMUF x Creator Live Streaming']
                    ]
                }
            }
        ...
        anima : function(){
            gsap.fromTo('.__main .s02 .b .b-01 img',{yPercent:5},{yPercent:0,yoyo:true,repeat:-1,ease:"Power1.easeInOut",duration:3})
            gsap.fromTo('.__main .s02 .b .b-02 img',{yPercent:5},{yPercent:0,yoyo:true,repeat:-1,ease:"Power1.easeInOut",duration:2})
        }
    },
    s4 : {
        init : function(){
        ...
        anima : function(){
            ...
            gsap.fromTo('.__main .s04 .o .o_1',{rotate:-5},{rotate:10,repeat:-1,yoyo:true,ease:"Power2.easeInOut",duration:1});
            gsap.fromTo('.__main .s04 .o .o_2',{rotate:-5},{rotate:10,repeat:-1,yoyo:true,ease:"Power2.easeInOut",duration:1});

            gsap.fromTo('.__main .s04 .o .o_3',{scale:0.98},{scale:1.025,repeat:-1,yoyo:true,ease:"Back.easeInOut.config(1.7)",duration:1});
            gsap.fromTo('.__main .s04 .o .o_4',{scale:0.98},{scale:1.025,repeat:-1,yoyo:true,ease:"Back.easeInOut.config(1.7)",duration:1});
        }
    },
    s5 : {
        init : function(){
        ...
        anima : function(){
            gsap.fromTo('.__main .s05 .o',{scaleY:0.98},{scaleY:1,repeat:-1,yoyo:true,ease:"Back.easeInOut.config(1.7)",transformOrigin:"bottom bottom",duration:1});
        }
    },
    s6 : {
        init : function(){
        ...
        anima : function(){
            gsap.fromTo('.__main .s06 .o',{yPercent:5},{yPercent:0,yoyo:true,repeat:-1,ease:"Power1.easeInOut",duration:2})
        }
    }
}